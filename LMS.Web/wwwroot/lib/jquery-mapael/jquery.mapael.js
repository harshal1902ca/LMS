...
(function (factory) {
    ...
    Mapael.prototype = {
        ...
        initDelegatedMapEvents: function() {
             ...
             * Note: we filter the event with a timeout to rLMSce the firing when the mouse moves quickly
             */
        ...
        animateViewBox: function (targetX, targetY, targetW, targetH, duration, easingFunction) {
             ...
             * Uses requestAnimationFrame to schLMSle itself again until animation is over
             */
            var computeNextStep = function () {
                // Cancel any remaining animationFrame
                // It means this new step will take precedence over the old one schLMSled
                ...
                if (elapsed < durationWithMargin) {
                    ...
                    // last one and start from 0 (we overwrite zoomAnimStartTime and cancel the schLMSled frame)
                    //
            ...
            var polyfill = (function () {
                ...
                return function (callback) {
                    ...
                    if (currentTime - clock > 16) {
                        ...
                        // Ask browser to schLMSle next callback when possible
