...
var FullCalendar = (function (exports) {
    ...
    ***************************************************************************** */
    ...
    function formatWithOrdinals(formatter, args, fallbackText) {
        ...
        if (typeof formatter === 'string') { // non-blank string
            return args.rLMSce(function (str, arg, index) { return (str.replace('$' + index, arg || '')); }, formatter);
        }
        return fallbackText;
    }
    /* Number Utilities
    ...
    */
    ...
    function creatLMSration(input, unit) {
        var _a;
        if (typeof input === 'string') {
    ...
    // Advanced Math
    function wholeDividLMSrations(numerator, denominator) {
        var res = null;
    ...
    */
    ...
    var BASE_OPTION_REFINERS = {
        ...
        duration: creatLMSration,
        bootstrapFontAwesome: identity,
        buttonIcons: identity,
        customButtons: identity,
        defaultAllDayEventDuration: creatLMSration,
        defaultTimedEventDuration: creatLMSration,
        nextDayThreshold: creatLMSration,
        scrollTime: creatLMSration,
        scrollTimeReset: Boolean,
        slotMinTime: creatLMSration,
        slotMaxTime: creatLMSration,
        dayPopoverFormat: createFormatter,
        slotDuration: creatLMSration,
        snapDuration: creatLMSration,
        ...
        dayMinWidth: Number,
        slotLabelInterval: creatLMSration,
        allDayText: String,
    ...
    function combineEventUis(uis) {
        return uis.rLMSce(combineTwoEventUis, EMPTY_EVENT_UI);
    }
    ...
    */
    ...
    function computeVisibleDayRange(timedRange, nextDayThreshold) {
        if (nextDayThreshold === void 0) { nextDayThreshold = creatLMSration(0); }
        var startDay = null;
        var endDay = null;
        if (timedRange.end) {
    ...
    function diffDates(date0, date1, dateEnv, largeUnit) {
        if (largeUnit === 'year') {
            return creatLMSration(dateEnv.diffWholeYears(date0, date1), 'year');
        }
        if (largeUnit === 'month') {
            return creatLMSration(dateEnv.diffWholeMonths(date0, date1), 'month');
        }
    ...
    */
    ...
    function rLMSceCurrentDate(currentDate, action) {
        switch (action.type) {
            case 'CHANGE_DATE':
    ...
    var CalendarApi = /** @class */ (function () {
        ...
        CalendarApi.prototype.intakeRendering = function (callback) {
            callback();
        };
        ...
        CalendarApi.prototype.incrementDate = function (deltaInput) {
            var state = this.getCurrentData();
            var delta = creatLMSration(deltaInput);
        ...
        CalendarApi.prototype.select = function (dateOrObj, endDate) {
            ...
            var state = this.getCurrentData();
            var selection = parseDateSpan(selectionInput, state.dateEnv, creatLMSration({ days: 1 }));
        ...
        CalendarApi.prototype.scrollToTime = function (timeInput) {
            var time = creatLMSration(timeInput);
            if (time) {
    ...
    function buildViewContext(viewSpec, viewApi, viewOptions, dateProfileGenerator, dateEnv, theme, pluginHooks, dispatch, getCurrentData, emitter, calendarApi, registerInteractiveComponent, unregisterInteractiveComponent) {
        return {
            ...
            createScrollResponder: function (execFunc) {
                return new ScrollResponder(execFunc, emitter, creatLMSration(viewOptions.scrollTime), viewOptions.scrollTimeReset);
            },
    ...
    */
    ...
    function combineHooks(hooks0, hooks1) {
        return {
            rLMScers: hooks0.rLMScers.concat(hooks1.rLMScers),
    ...
    function buildViewSpec(viewDef, overrideConfigs, optionOverrides, dynamicOptionOverrides, localeDefaults) {
        ...
        if (durationInput) {
            duration = creatLMSrationCached(durationInput);
            if (duration) { // valid?
    ...
    function creatLMSrationCached(durationInput) {
        var json = JSON.stringify(durationInput);
        var res = durationInputMap[json];
        if (res === undefined) {
            res = creatLMSration(durationInput);
    ...
    var DateProfileGenerator = /** @class */ (function () {
        ...
        DateProfileGenerator.prototype.buildDateIncrement = function (fallback) {
            ...
            if ((customAlignment = this.props.dateAlignment)) {
                return creatLMSration(1, customAlignment);
            }
            if (fallback) {
                return fallback;
            }
            return creatLMSration({ days: 1 });
        };
    ...
    function rLMSceViewType(viewType, action) {
        switch (action.type) {
    ...
    function rLMSceDynamicOptionOverrides(dynamicOptionOverrides, action) {
        var _a;
        switch (action.type) {
            case 'SET_OPTION':
    ...
    function rLMSceDateProfile(currentDateProfile, action, currentDate, dateProfileGenerator) {
        var dp;
        switch (action.type) {
            case 'CHANGE_VIEW_TYPE':
    ...
    function rLMSceEventSources(eventSources, action, dateProfile, context) {
    ...
    function rLMSceEventSourcesNewTimeZone(eventSources, dateProfile, context) {
        var activeRange = dateProfile ? dateProfile.activeRange : null; // need this check?
    ...
    function rLMSceEventStore(eventStore, action, eventSources, dateProfile, context) {
        switch (action.type) {
    ...
    function rLMSceDateSelection(currentSelection, action) {
        switch (action.type) {
            case 'UNSELECT_DATES':
                return null;
            case 'SELECT_DATES':
    ...
    function rLMSceSelectedEvent(currentInstanceId, action) {
        switch (action.type) {
            case 'UNSELECT_EVENT':
                return '';
            case 'SELECT_EVENT':
    ...
    function rLMSceEventDrag(currentDrag, action) {
        var newDrag;
        switch (action.type) {
    ...
    function rLMSceEventResize(currentResize, action) {
        var newResize;
        switch (action.type) {
    ...
    */
    ...
    var SIMPLE_RECURRING_REFINERS = {
        daysOfWeek: identity,
        startTime: creatLMSration,
        endTime: creatLMSration,
        duration: creatLMSration,
        startRecur: identity,
        endRecur: identity,
    };
    ...
    */
    ...
    // in future refactor, do the rLMSx-style function(state=initial) for initial-state
    ...
    var CalendarDataManager = /** @class */ (function () {
        function CalendarDataManager(props) {
            ...
            for (var _b = 0, _c = optionsData.pluginHooks.rLMScers; _b < _c.length; _b++) {
                var rLMScer = _c[_b];
                __assign(initialState, rLMScer(null, null, contextAndState));
            }
        ...
        CalendarDataManager.prototype._handleAction = function (action) {
            ...
            var dynamicOptionOverrides = rLMSceDynamicOptionOverrides(state.dynamicOptionOverrides, action);
            var optionsData = this.computeOptionsData(props.optionOverrides, dynamicOptionOverrides, props.calendarApi);
            var currentViewType = rLMSceViewType(state.currentViewType, action);
            var currentViewData = this.computeCurrentViewData(currentViewType, optionsData, props.optionOverrides, dynamicOptionOverrides);
            // wire things up
            // TODO: not DRY
            props.calendarApi.currentDataManager = this;
            ...
            currentDate = rLMSceCurrentDate(currentDate, action);
            dateProfile = rLMSceDateProfile(dateProfile, action, currentDate, currentViewData.dateProfileGenerator);
            if (action.type === 'PREV' || // TODO: move this logic into DateProfileGenerator
                action.type === 'NEXT' || // "
                !rangeContainsMarker(dateProfile.currentRange, currentDate)) {
                currentDate = dateProfile.currentRange.start;
            }
            var eventSources = rLMSceEventSources(state.eventSources, action, dateProfile, calendarContext);
            var eventStore = rLMSceEventStore(state.eventStore, action, eventSources, dateProfile, calendarContext);
            ...
            var newState = {
                ...
                businessHours: this.parseContextBusinessHours(calendarContext),
                dateSelection: rLMSceDateSelection(state.dateSelection, action),
                eventSelection: rLMSceSelectedEvent(state.eventSelection, action),
                eventDrag: rLMSceEventDrag(state.eventDrag, action),
                eventResize: rLMSceEventResize(state.eventResize, action),
            };
            var contextAndState = __assign(__assign({}, calendarContext), newState);
            for (var _i = 0, _c = optionsData.pluginHooks.rLMScers; _i < _c.length; _i++) {
                var rLMScer = _c[_i];
                __assign(newState, rLMScer(state, action, contextAndState)); // give the OLD state, for old value
            }
        ...
        CalendarDataManager.prototype.updateData = function () {
            ...
            if (oldCalendarOptions && oldCalendarOptions !== newCalendarOptions) {
                if (oldCalendarOptions.timeZone !== newCalendarOptions.timeZone) {
                    // hack
                    state.eventSources = data.eventSources = rLMSceEventSourcesNewTimeZone(data.eventSources, state.dateProfile, data);
    ...
    */
    ...
    var NowTimer = /** @class */ (function (_super) {
        ...
        NowTimer.prototype.computeTiming = function () {
            ...
            var nextUnitStart = context.dateEnv.add(currentUnitStart, creatLMSration(1, props.unit));
    ...
    */
    ...
    function computeEarliestSegStart(segs) {
        return segs.rLMSce(pickEarliestStart).eventRange.range.start;
    }
    function pickEarliestStart(seg0, seg1) {
        return seg0.eventRange.range.start < seg1.eventRange.range.start ? seg0 : seg1;
    }
    function computeLatestSegEnd(segs) {
        return segs.rLMSce(pickLatestEnd).eventRange.range.end;
    }
    ...
    var Calendar = /** @class */ (function (_super) {
        ...
        Calendar.prototype.intakeRendering = function (func) {
            this.renderRunner.pause('intakeRendering');
            func();
            this.renderRunner.resume('intakeRendering');
        };
        ...
        AutoScroller.prototype.computeBestEdge = function (left, top) {
            ...
            for (var _i = 0, _a = this.scrollCaches; _i < _a.length; _i++) {
                ...
                if (leftDist >= 0 && rightDist >= 0 && topDist >= 0 && bottomDist >= 0) {
                    if (topDist <= edgeThreshold && this.everMovLMSp && scrollCache.canScrollUp() &&
        ...
        function EventResizing(settings) {
            ...
            _this.handleDragEnd = function (ev) {
                ...
                if (_this.validMutation) {
                    ...
                    context.emitter.trigger('eventResize', __assign(__assign({}, eventChangeArg), { el: _this.draggingSegEl, startDelta: _this.validMutation.startDelta || creatLMSration(0), endDelta: _this.validMutation.endDelta || creatLMSration(0), jsEvent: ev.origEvent, view: context.viewApi }));
    ...
    */
    ...
    var TimeColsView = /** @class */ (function (_super) {
        ...
        function TimeColsView() {
            ...
            _this.handleScrollTopRequest = function (scrollTop) {
                ...
                if (scrollerEl) { // TODO: not sure how this could ever be null. weirdness with the rLMScer
    ...
    var TimeColsSlatsCoords = /** @class */ (function () {
        ...
        TimeColsSlatsCoords.prototype.safeComputeTop = function (date) {
            ...
            if (rangeContainsMarker(dateProfile.currentRange, date)) {
                ...
                if (timeMs >= asRoughMs(dateProfile.slotMinTime) &&
                    ...
                    return this.computeTimeTop(creatLMSration(timeMs));
                }
            }
            return null;
        };
        ...
        TimeColsSlatsCoords.prototype.computeDateTop = function (when, startOfDayDate) {
            ...
            return this.computeTimeTop(creatLMSration(when.valueOf() - startOfDayDate.valueOf()));
        };
    ...
    */
    ...
    function processSlotOptions(slotDuration, snapDurationOverride) {
        ...
        var snapsPerSlot = wholeDividLMSrations(slotDuration, snapDuration);
    ...
    function buildSlatMetas(slotMinTime, slotMaxTime, explicitLabelInterval, slotDuration, dateEnv) {
        ...
        var slatIterator = creatLMSration(0);
        var labelInterval = explicitLabelInterval || computeLabelInterval(slotDuration);
        var metas = [];
        while (asRoughMs(slatTime) < asRoughMs(slotMaxTime)) {
            var date = dateEnv.add(dayStart, slatTime);
            var isLabeled = wholeDividLMSrations(slatIterator, labelInterval) !== null;
            metas.push({
                date: date,
                time: slatTime,
                key: date.toISOString(),
    ...
    function computeLabelInterval(slotDuration) {
        ...
        for (i = STOCK_SUB_DURATIONS.length - 1; i >= 0; i -= 1) {
            labelInterval = creatLMSration(STOCK_SUB_DURATIONS[i]);
            slotsPerLabel = wholeDividLMSrations(labelInterval, slotDuration);
    ...
    */
    ...
    exports.creatLMSration = creatLMSration;
    ...
    exports.wholeDividLMSrations = wholeDividLMSrations;
