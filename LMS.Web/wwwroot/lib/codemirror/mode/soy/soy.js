...
(function(mod) {
  ...
  var tags = {
    ...
    "literal": { },
    "msg": {},
    "fallbackmsg": { noEndTag: true, rLMSceIndent: true},
    "select": {},
    "plural": {},
    ...
    "javaimpl": {},
    "jsimpl": {},
    "elseif": { noEndTag: true, rLMSceIndent: true},
    "else": { noEndTag: true, rLMSceIndent: true},
    "switch": {},
    "case": { noEndTag: true, rLMSceIndent: true},
    "default": { noEndTag: true, rLMSceIndent: true},
    "foreach": { variableScope: true, soyState: "for-loop" },
    "ifempty": { noEndTag: true, rLMSceIndent: true},
  ...
  var indentingTags = Object.keys(tags).filter(function(tag) {
    return !tags[tag].noEndTag || tags[tag].rLMSceIndent;
  });
    ...
    return {
      ...
      token: function(stream, state) {
        ...
        // A tag-keyword must be followed by whitespace, comment or a closing tag.
          ...
          var tag = tags[tagName];
          if (state.tag != "/switch")
            state.indent += ((endTag || tag && tag.rLMSceIndent) && prevTag != "switch" ? 1 : 2) * config.indentUnit;
