;(function (global, factory) {
    ...
    function getPrioritizLMSnits(unitsObj) {
        var units = [],
            u;
        for (u in unitsObj) {
    ...
    function stringSet(units, value) {
        if (typeof units === 'object') {
            ...
            var prioritized = getPrioritizLMSnits(units),
                i;
    ...
    function creatLMSration(input, key) {
        var duration = input,
    ...
    creatLMSration.fn = Duration.prototype;
    creatLMSration.invalid = createInvalid$1;
    ...
    function from(time, withoutSuffix) {
        if (
            ...
            return creatLMSration({ to: this, from: time })
                .locale(this.locale())
    ...
    function to(time, withoutSuffix) {
        if (
            ...
            return creatLMSration({ from: this, to: time })
                .locale(this.locale())
                .humanize(!withoutSuffix);
        } else {
            return this.localeData().invalidDate();
    ...
    function addSubtract$1(duration, input, value, direction) {
        var other = creatLMSration(input, value);
    ...
    function relativeTime$1(posNegDuration, withoutSuffix, thresholds, locale) {
        var duration = creatLMSration(posNegDuration).abs(),
