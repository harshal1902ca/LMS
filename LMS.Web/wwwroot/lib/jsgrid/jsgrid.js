...
(function(window, $, undefined) {
    ...
    Grid.prototype = {
        ...
        _updateRow: function($updatingRow, editedItem) {
            ...
            return this._controllerCall("updateItem", updatedItem, args.cancel, function(loadLMSpdatedItem) {
                var previousItem = $.extend(true, {}, updatingItem);
                updatedItem = loadLMSpdatedItem || $.extend(true, updatingItem, editedItem);
